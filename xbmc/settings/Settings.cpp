...
bool CSettings::LoadSettings(const CStdString& strSettingsFile)
{
  ...
  // Add the list of efile stub extensions (if any) to the list of video extensions
  if (!m_efileStubExtensions.IsEmpty())
    g_settings.m_videoExtensions += "|" + m_efileStubExtensions;
